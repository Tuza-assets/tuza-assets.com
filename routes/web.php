...
use App\Http\Controllers\IremboPayController;
use App\Models\User;
...
Route::post('payment/irembo', [IremboPayController::class, 'iremboPayment'])->name('pay.irembo');
Route::get('payment/irembo/initialization', [IremboPayController::class, 'iremboPaymentInitialization'])->name('irembo.payment.initialization');
Route::match(['GET', 'POST'], 'payment/irembo/callback', [IremboPayController::class, 'iremboPaymentCallback'])->name('irembo.payment.callback');
