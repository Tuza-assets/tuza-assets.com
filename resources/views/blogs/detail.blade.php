...
@section('content')
<div class="mt-14 bg-white ml-162 container-fluid">
                ...
                <div class="col-md-8">
                    <div class="border border-warning">
                        @if (!empty($blog->images))
                            <img src="{{ asset('blog_images/' . $blog->images) }}" class="img-fluid" alt="Post Image">
                        @endif
                        <div class="card-body">
                            <div class="post-meta">
                            ...
                            <div class="share-buttons">
                                <button onclick="shareWhatsApp()" class="m-1 btn btn-success btn-sm">
                                    <i class="fab fa-whatsapp"></i>
                                </button>
                                <button onclick="shareLinkedIn()" class="btn btn-success btn-sm">
                                    <i class="fab fa-linkedin"></i>
                                </button>
                                <button onclick="copyLink()" class="m-1 btn btn-success btn-sm">
