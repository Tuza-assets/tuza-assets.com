...
@section('content')
    <div class="mx-4 mt-14 bg-white container-fluid">
        <div class="row">
                ...
                <form action="{{ route('admin.blogs.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-2 gap-4"> <!-- Grid layout with 2 columns -->
                        ...
                        <div class="form-group d-flex">
                            ...
                            <div class="px-3">
                                <!-- Add Category Button -->
                                <button type="button" class="ml-2 btn btn-sm btn-primary" data-toggle="modal"
                        ...
                        <!-- Summary -->
                        <div class="col-span-2 form-group"> <!-- Full width in grid -->
                        ...
                        <!-- Blog Cover Image -->
                        <div class="col-span-2 form-group d-flex flex-column"> <!-- Full width in grid -->
