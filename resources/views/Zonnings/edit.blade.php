            ...
            <form action="{{ route('admin.Zonning.update', $Zonning->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" id="title"
                        value="{{ old('name', $Zonning->name ?? '') }}" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div>
                        @php
                            $images = is_string($Zonning->images)
                                ? json_decode($Zonning->images, true)
                                : $Zonning->images;
                        @endphp
                        @if (is_array($images))
                            ...
                            @endforeach
                        @else
                            <img src="{{ asset('public/storage/default.jpg') }}" class="img-thumbnail"
