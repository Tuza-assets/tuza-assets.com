            ...
            <div class="container p-3 mx-auto col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="{{ route('partner.properties.edit', $property) }}" class="btn btn-primary">Edit
                                Property</a>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-4 col-md-12">
                                @if ($property->mainimage)
                                    <img src="{{ asset($property->mainimage) }}" alt="Main Image" class="rounded img-fluid"
                            ...
                            @if ($property->mainimage)
                                <div class="mb-3">
                                    ...
                                    <img src="{{ asset($property->mainimage) }}" alt="Main Property Image"
                                        class="img-thumbnail" style="max-height: 300px; width: 100%; object-fit: cover;">
                                </div>
                            @endif
                        </div>
                    </div>
